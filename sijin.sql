...
--
-- Host: 127.0.0.1:4306
-- Generation Time: Nov 03, 2022 at 10:17 AM
...
CREATE TABLE `employee` (
  ...
  `emp_nation` varchar(20) DEFAULT NULL,
  `emp_extraction` varchar(20) DEFAULT NULL,
  `emp_birthday` datetime DEFAULT NULL,
  `emp_type` varchar(20) DEFAULT NULL,
  `emp_hire` date DEFAULT NULL,
...
(11122001, '2022-11-01', '08:25:49', 'กะชัง 8', 3, 'สิ้นสุดการขาย'),
(21122001, '2022-11-02', '11:48:39', 'กะชัง 30', 7, 'สิ้นสุดการขาย'),
(21122002, '2022-11-02', '11:54:38', 'กะชัง 1', 9, 'สิ้นสุดการขาย'),
(31122001, '2022-11-03', '01:53:46', 'กะชัง 26', 9, 'สิ้นสุดการขาย'),
(31122003, '2022-11-03', '12:02:39', 'กะชัง 8', 6, 'สิ้นสุดการขาย'),
(301022001, '2022-10-30', '06:36:17', 'กะชัง 6', 6, 'สิ้นสุดการขาย');
...
(62, 21122001, 'อาหาร', 'ปลาแซลม่อนแช่น้ำปลา', 1, 250),
(63, 21122001, 'อาหาร', 'ปลาพงราดซอสสับปะรด', 1, 350),
(64, 21122001, 'อาหาร', 'ลาบแซลมอนสด ', 1, 250),
(65, 21122001, 'อาหาร', 'กระเพาะปลา+เยื้อไผ่น้ำแดงเนื้อปู', 1, 250),
(66, 21122001, 'อาหาร', 'เนื้อปลาคังลวกจิ้ม ', 1, 220),
(67, 21122001, 'อาหาร', 'เนื้อปลาเก๋าลวกจิ้ม ', 1, 220),
(68, 21122001, 'อาหาร', 'ปูนิ่มผัดพริกไทยดำ', 1, 350),
(69, 21122001, 'อาหาร', 'ข้าวผัดมันกุ้ง (กลาง)', 1, 150),
(70, 21122001, 'เครื่องดื่ม', 'เอส', 1, 25),
(71, 21122001, 'เครื่องดื่ม', 'เอสลิตร', 1, 50),
(72, 21122001, 'เครื่องดื่ม', 'น้ำแข็ง (โถ)', 1, 60),
(73, 21122002, 'อาหาร', 'ปลาแซลม่อนแช่น้ำปลา', 1, 250),
(74, 21122002, 'อาหาร', 'ปลาพงราดซอสสับปะรด', 1, 350),
(75, 21122002, 'อาหาร', 'ลาบแซลมอนสด ', 1, 250),
(76, 21122002, 'อาหาร', 'ห่อหมกทะเลมะพร้าวอ่อน', 1, 200),
(77, 21122002, 'อาหาร', 'กระเพาะปลา+เยื้อไผ่น้ำแดงเนื้อปู', 1, 250),
(78, 21122002, 'เครื่องดื่ม', 'น้ำโพลาลิส', 1, 20),
(79, 21122002, 'เครื่องดื่ม', 'น้ำแข็ง (เล็ก)', 1, 30),
(80, 21122002, 'เครื่องดื่ม', 'น้ำแข็ง (โถ)', 1, 60),
(81, 21122002, 'เครื่องดื่ม', 'เอสลิตร', 1, 50),
(82, 21122002, 'เครื่องดื่ม', 'เอส', 1, 25),
(83, 31122003, 'อาหาร', 'ปลาแซลม่อนแช่น้ำปลา', 1, 250),
(84, 31122003, 'อาหาร', 'ปลาพงราดซอสสับปะรด', 1, 350),
(85, 31122003, 'อาหาร', 'ทะเลผัดฉ่ากระทะร้อน', 1, 220),
(86, 31122001, 'อาหาร', 'ปลาแซลม่อนแช่น้ำปลา', 1, 250),
(87, 31122001, 'อาหาร', 'ลาบแซลมอนสด ', 1, 250),
(88, 31122001, 'อาหาร', 'ห่อหมกทะเลมะพร้าวอ่อน', 1, 200),
(89, 31122001, 'อาหาร', 'เนื้อปลาเก๋าลวกจิ้ม ', 1, 220),
(90, 31122001, 'อาหาร', 'ปีกไก่ทอดน้ำปลา', 1, 120),
(91, 31122001, 'อาหาร', 'ไก่บ้านทอดเกลือ', 1, 120),
(92, 31122001, 'เครื่องดื่ม', 'น้ำโพลาลิส', 1, 20),
(93, 31122001, 'เครื่องดื่ม', 'น้ำแข็ง (เล็ก)', 1, 30),
(94, 31122001, 'เครื่องดื่ม', 'เอสลิตร', 1, 50),
(95, 31122001, 'เครื่องดื่ม', 'เอส', 1, 25);
...
--
ALTER TABLE `ordermenu`
  MODIFY `orderMenu_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
